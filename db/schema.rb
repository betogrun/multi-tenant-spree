...
ActiveRecord::Schema.define(version: 20171207195027) do
  ...
  create_table "stores", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "spree_tenant_id"
    t.index ["seller_id"], name: "index_stores_on_seller_id"
    t.index ["spree_tenant_id"], name: "index_stores_on_spree_tenant_id"
  end

  add_foreign_key "stores", "sellers"
  add_foreign_key "stores", "spree_tenants"
end
